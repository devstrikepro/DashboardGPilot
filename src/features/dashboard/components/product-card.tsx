...
export function ProductCard({ title, avgMonthProfit, percentDD, initials, loading, onClick, formatCurrency }: ProductCardProps) {
  ...
  if (loading) {
    return <Skeleton variant="rectangular" height={160} sx={{ borderRadius: 3, bgcolor: "rgba(255,255,255,0.03)" }} />;
  }
    ...
    <Card
      sx={{
        ...
        "&:hover": {
          ...
          borderColor: (theme) => (theme.palette.mode === "dark" ? "rgba(34, 211, 238, 0.6)" : "rgba(8, 145, 178, 0.6)"),
          bgcolor: (theme) => (theme.palette.mode === "dark" ? "rgba(34, 211, 238, 0.05)" : "rgba(8, 145, 178, 0.03)"),
          "& .metric-value": {
            color: "primary.main",
    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Metric Section */}
          <Box sx={{ textAlign: "right", flexShrink: 0, maxWidth: { xs: 110, sm: 140, md: "none" } }}>
            <Typography
              variant="caption"
              sx={{
                display: "block",
